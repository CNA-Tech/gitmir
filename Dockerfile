...
ADD root/.webhookHandler.cgi /usr/local/apache2/cgi-bin/webhookHandler.cgi
...
ADD root/.Webhook.pm /etc/perl/Webhook.pm
...
RUN chmod 755 /usr/local/apache2/cgi-bin/webhookHandler.cgi
